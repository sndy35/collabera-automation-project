...
import com.collabera.android.testdata.Test;
import com.collabera.android.testdata.TestParameters;
import com.collabera.android.testdata.Testdata;
import com.collabera.reporting.Logger;
import com.collabera.utils.CommandLineParameters;
	...
	private void initializeDriver() throws MalformedURLException {
		try {
			...
			capabilities.setCapability("newCommandTimeout",
					Integer.parseInt(System.getProperty(CommandLineParameters.NEW_COMMAND_TIMEOUT)));
